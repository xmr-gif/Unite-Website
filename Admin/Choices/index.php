            ...
            <div >
                ...
                <div class="bg-white px-9 py-4 rounded-3xl h-[72vh] " >
                    <div class="flex justify-between border-b-1 pt-4 pb-5 border-zinc-400" >
                        ...
                        <!-- add hidden here -->
                        <div class="text-sm py-2 pl-80 " >
                            <button class="border text-zinc-500 px-2 rounded-md border-zinc-400 cursor-pointer hover:border-blue-600 hover:text-blue-600">
                                Accept
                            </button>
                            <button class="border text-zinc-500 px-2 rounded-md border-zinc-400 cursor-pointer hover:border-orange-600 hover:text-orange-600">
                                Reject
                            </button>
                        </div>
